...
// ================================================================
// Selezione tema:
//   0 = Tema iniziale originale
//   1 = Tema nuovo (nero + vivace)
//   2 = Tema Premium Vibrant Dark (Neon)
#ifndef UI_THEME_ID
#define UI_THEME_ID 2
#endif

#if (UI_THEME_ID == 0)
  // Tema iniziale originale
  ...
  #define UI_COL_BTN_TEXT    lv_color_make(0xA0,0xA0,0xB8)
  ...
  #define UI_COL_GRAPH_HDR   lv_color_make(0x6A,0xC8,0x86)
  #define UI_COL_GRAPH_BG    lv_color_make(0x0D,0x16,0x12)
  #define UI_COL_GRAPH_BRD   lv_color_make(0x3A,0x73,0x54)
  #define UI_COL_SAFETY_BG   lv_color_make(0x70,0x28,0x28)
#elif (UI_THEME_ID == 1)
  // Tema nuovo (nero + vivace)
  #define UI_COL_BG          lv_color_make(0x0A,0x0A,0x0A)
  #define UI_COL_SURFACE     lv_color_make(0x14,0x14,0x14)
  #define UI_COL_SURFACE_ALT lv_color_make(0x1E,0x1E,0x1E)
  #define UI_COL_BORDER      lv_color_make(0x4E,0x4E,0x4E)
  #define UI_COL_TEXT_DIM    lv_color_make(0xC9,0xC9,0xC9)
  #define UI_COL_ERR         lv_color_make(0xDE,0x6A,0x58)
  #define UI_COL_ACCENT      lv_color_make(0xE3,0x6E,0x42)
  #define UI_COL_ACCENT2     lv_color_make(0xFF,0xBD,0x92)
  #define UI_COL_CIELO       lv_color_make(0x83,0xC3,0xE8)
  #define UI_COL_LUCE        lv_color_make(0xEC,0xD0,0x70)
  #define UI_COL_TUNING      lv_color_make(0x7C,0xCF,0xD8)
  #define UI_COL_SETPOINT    lv_color_make(0xF8,0xE0,0xCF)
  #define UI_COL_WHITE       lv_color_make(0xF8,0xEF,0xE4)
  #define UI_COL_GRAY        lv_color_make(0xAE,0xAE,0xAE)
  #define UI_COL_BTN_TEXT    lv_color_make(0xE6,0xE0,0xD8)
  #define UI_COL_DARKGRAY    lv_color_make(0x06,0x06,0x06)
  #define UI_COL_GREEN       lv_color_make(0x6F,0xC3,0x92)
  #define UI_COL_CYAN        lv_color_make(0x7A,0xCD,0xE2)
  #define UI_COL_GRAPH_HDR   lv_color_make(0x7E,0xE2,0xA4)
  #define UI_COL_GRAPH_BG    lv_color_make(0x10,0x10,0x10)
  #define UI_COL_GRAPH_BRD   lv_color_make(0x3F,0x3F,0x3F)
  #define UI_COL_SAFETY_BG   lv_color_make(0x7C,0x2A,0x24)
#else
  // Tema 2: Premium Vibrant Dark (Neon)
  #define UI_COL_BG          lv_color_make(0x0A,0x0D,0x14)
  #define UI_COL_SURFACE     lv_color_make(0x16,0x1A,0x26)
  #define UI_COL_SURFACE_ALT lv_color_make(0x22,0x28,0x3A)
  #define UI_COL_BORDER      lv_color_make(0x38,0x44,0x5C)
  #define UI_COL_TEXT_DIM    lv_color_make(0xA0,0xAB,0xBA)
  #define UI_COL_ERR         lv_color_make(0xFF,0x17,0x44)
  #define UI_COL_ACCENT      lv_color_make(0xFF,0x57,0x22)
  #define UI_COL_ACCENT2     lv_color_make(0xFF,0x9A,0x7A)
  #define UI_COL_CIELO       lv_color_make(0x00,0xE5,0xFF)
  #define UI_COL_LUCE        lv_color_make(0xFF,0xD7,0x00)
  #define UI_COL_TUNING      lv_color_make(0x64,0xFF,0xDA)
  #define UI_COL_SETPOINT    lv_color_make(0xFF,0xFF,0xFF)
  #define UI_COL_WHITE       lv_color_make(0xFF,0xFF,0xFF)
  #define UI_COL_GRAY        lv_color_make(0x8A,0x95,0xA5)
  #define UI_COL_BTN_TEXT    lv_color_make(0xE2,0xE8,0xF0)
  #define UI_COL_DARKGRAY    lv_color_make(0x0F,0x13,0x1A)
  #define UI_COL_GREEN       lv_color_make(0x00,0xE6,0x76)
  #define UI_COL_CYAN        lv_color_make(0x00,0xE5,0xFF)
  #define UI_COL_GRAPH_HDR   lv_color_make(0x00,0xE6,0x76)
  #define UI_COL_GRAPH_BG    lv_color_make(0x0A,0x0D,0x14)
  #define UI_COL_GRAPH_BRD   lv_color_make(0x22,0x28,0x3A)
  #define UI_COL_SAFETY_BG   lv_color_make(0x8A,0x14,0x22)
#endif
